...
// Every test in this file gets its own scratch daemon (worker-scoped: beforeAll runs
// once per worker for the tests it executes from this file — docs/conventions.md's
// "never attach to an existing server").
