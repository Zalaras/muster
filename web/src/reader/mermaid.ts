// Pure helpers for the diagram pass: recognising a mermaid fence, mapping the dashboard
// theme to one of mermaid's two built-in themes, formatting a failed fence's reason line,
// and naming a diagram instance.
 ...
 * still match while `language-mermaidjs` must not. */
 ...
 * empty and unrecognised alike — maps to `dark`. */
...
/** The failure line text: `diagram not rendered: ` plus the first non-empty line of
 ...
 * position in document order — two identical fences still get distinct ids. */
