...
**Reached by**: user decision (the developer, 2026-08-28). Not debated — the issue touches the protocol contract (§4.2/§7.3), which the `decide` skill's never-debated list routes to the user.
