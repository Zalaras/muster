...
// to exit, but give up and warn once ctx is done", needed by both internal/session's
// liveness poll and internal/server's ingest queue and four pollers. internal/session must
