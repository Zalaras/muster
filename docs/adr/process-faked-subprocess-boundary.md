...
refs: [docs/history/spec-changelog.md, docs/design/test-strategy.md, docs/conventions.md, TODO.md, kb:adr/usage-keychain-token-read-only, kb:adr/process-tests-run-space-bearing-data-dir, kb:adr/process-e2e-explicit-fixtures]
supersedes: []
---
