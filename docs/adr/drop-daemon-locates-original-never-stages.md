...
**Decision.** B, settled with the developer at planning. It must be the original file or nothing; an unlocatable or ambiguous file shows a notice on the pane and types nothing.
