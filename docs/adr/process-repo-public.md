...
files: [scripts/go-public.sh, docs/go-public.md, docs/history/design/open-sourcing.md, LICENSE, README.md]
tests: []
refs: [docs/history/spec-changelog.md, docs/go-public.md, docs/history/design/open-sourcing.md, kb:adr/process-licence-mit, kb:adr/process-contributions-deferred-to-first-pr, kb:adr/process-main-ruleset-blocks-deletion-and-force-push-only, kb:adr/process-dependabot-version-prs-off, kb:adr/release-no-ci-test-job-yet]
supersedes: []
---
