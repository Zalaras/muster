...
tests: []
refs: [docs/history/spec-changelog.md, docs/history/design/test-strategy.md, docs/conventions.md, plan:file-drop-fix, kb:adr/process-e2e-explicit-fixtures, kb:adr/process-e2e-no-playwright-retries]
supersedes: []
---
