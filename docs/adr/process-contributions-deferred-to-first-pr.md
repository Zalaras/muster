...
**Decision.** B, the developer's decision. The tool is a personal one and the README sets expectations: issues are welcome, pull requests are not accepted at this time, so the machinery would guard a door that is closed.
