...
tests: []
refs: [docs/history/spec-changelog.md, docs/history/design/test-strategy.md, docs/conventions.md, kb:adr/process-e2e-explicit-fixtures, kb:adr/process-e2e-one-load-policy, kb:adr/process-transient-displays-not-oracles]
supersedes: []
---
