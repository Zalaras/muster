<!-- kb:generated 122848718bb792f0 — regenerated by make gen-kb; edit the sources, not this file -->
# settings — protocol contract

Slices of `docs/protocol.md` named by the protocol list in `docs/features/settings/spec.md`.
