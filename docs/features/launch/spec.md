...
features: [launch]
tags: [tmux]
go: [internal/server/browse*.go, internal/server/repos*.go, internal/server/sessions*.go, internal/server/main_test.go, internal/claudecode/launch*.go, internal/claudecode/modelcheck*.go, internal/gitutil/**, internal/store/repo*.go]
web: [web/src/features/launch.ts, web/src/render/crumbs*.ts, web/src/render/launchrestore*.ts, web/src/sessions/permission*.ts]
