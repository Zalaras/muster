...
features: [connection]
tags: [auth, security]
go: [cmd/musterd/**, internal/server/server*.go, internal/server/respond*.go, internal/server/auth*.go, internal/server/ws*.go, internal/server/state*.go, internal/server/staticserve_test.go, internal/server/fakes_test.go, internal/server/helpers_test.go, internal/webui/**]
