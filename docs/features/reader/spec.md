...
go: [internal/claudecode/plan*.go, internal/claudecode/files*.go, internal/server/reader*.go, internal/reader/**, internal/session/reader_test.go, internal/store/migrations/0008_reader.sql]
