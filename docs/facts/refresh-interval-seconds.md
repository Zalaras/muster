...
Evidence: 2.1.233 spikes (FINDINGS §5b) and the 2026-08-25 quoting probe (capture-4). Not
asserted; automatable — run D idles ~60 s waiting for `idle_prompt`, long enough to count ticks
if the harness set the key.
